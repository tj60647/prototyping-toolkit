...
- After a push, confirm the deployment for that commit reached READY, then load the production URL signed out. Students must get the page, not a Vercel login.
